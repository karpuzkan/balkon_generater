...
def add_object(s,context):
    ...
    blok=[]#    [ Tip ][             Balkon           [                    Fuga                        ] [  Parapet  ] [   Mermer  ] [       Krom      ] [  Cam  ]
...
#OBJE -----------------------------------------------------------
    mesh = bpy.data.meshes.new(name='Balkon')
    mesh.from_pydata(vr,[],fc)
    for i in SM:
        mesh.polygons[i].use_smooth = 1
    mesh.materials.append(MAT('Balkon', 0.66,0.64,0.72))
    ...
    object_data_add(context, mesh, operator=s)
    if bpy.context.mode != 'EDIT_MESH':
        bpy.ops.object.editmode_toggle()
        bpy.ops.object.editmode_toggle()
#----------------------------------------------------------------
class OBJECT_OT_add_Balkon(bpy.types.Operator, AddObjectHelper):
    bl_idname = "mesh.add_say3d_balkon"
    bl_label = "Balkon"
    bl_description = "Balkon Olustur"
    ...
    duz=IntProperty(min=  1,max=500,default=100,description="Balkon Genisligi")
    ...
    #Tip
    ls0=EnumProperty(items=(("1","Balkon",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="1")
    #Balkon
    ...
    #--------------------------------------------------------------
    #Tip
    ls1=EnumProperty(items=(("1","Balkon",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="3")
    #Balkon
    ...
    #--------------------------------------------------------------
    #Tip
    ls2=EnumProperty(items=(("1","Balkon",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balkon
    ...
    #--------------------------------------------------------------
    #Tip
    ls3=EnumProperty(items=(("1","Balkon",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balkon
    ...
    #--------------------------------------------------------------
    #Tip
    ls4=EnumProperty(items=(("1","Balkon",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balkon
    ...
    #--------------------------------------------------------------
    #Tip
    ls5=EnumProperty(items=(("1","Balkon",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balkon
    ...
    #--------------------------------------------------------------
    #Tip
    ls6=EnumProperty(items=(("1","Balkon",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balkon
    ...
    #--------------------------------------------------------------
    #Tip
    ls7=EnumProperty(items=(("1","Balkon",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balkon
...
def add_object_button(self, context):
    self.layout.operator(
        OBJECT_OT_add_Balkon.bl_idname,
        text="Balkon",
        icon="SNAP_FACE")
def register():
    bpy.utils.register_class(OBJECT_OT_add_Balkon)
    bpy.types.INFO_MT_mesh_add.append(add_object_button)
def unregister():
    bpy.utils.unregister_class(OBJECT_OT_add_Balkon)
